...
const categories = ["Animals", "Arts & Crafts", "Food and Beverage", "Martial Arts", "Music and Performing Arts", "Outdoor Recreation", "Personal Fitness/ Sports", "Shooting Sports", "Trades", "Vehicle Operation", "Water Recreation"];
const Index = () => {
  const [searchQuery, setSearchQuery] = useState("");
  return <div className="min-h-screen flex flex-col">
      <Header searchQuery={searchQuery} onSearchChange={setSearchQuery} />

      <main className="container mx-auto flex gap-8 flex-1 py-[16px]">
        <Sidebar categories={categories} />

        <div className="flex-1 space-y-6">
          {businesses.map(business => <BusinessCard key={business.id} name={business.name} description={business.description} distance={business.distance} image={business.image} />)}
